...
> Diseño maestro detallado de los 17 módulos del curso de certificación. Este documento es la **fuente única de verdad** para la producción de contenido: define objetivos, duraciones, laboratorios, conceptos clave y el reparto de preguntas del examen final. Cualquier cambio en la estructura del curso se refleja primero aquí y luego se propaga al contenido fuente.

**Estado:** ✅ Versión 1.0 (Fase 1 completada)
...
- [1. Mapa de competencias del curso](#1-mapa-de-competencias-del-curso)
- [2. Resumen de los 17 módulos](#2-resumen-de-los-17-módulos)
- [3. Detalle por módulo](#3-detalle-por-módulo)
- [4. Estructura del examen final](#4-estructura-del-examen-final)
- [5. Matriz de competencias completa](#5-matriz-de-competencias-completa)
...
Al completarlo, el alumno demuestra competencia en las ocho áreas que estructuran el examen final.
...
| Criterio | Umbral |
|---|---|
| Asistencia / progreso del curso | 100% de los 16 módulos teóricos completados |
| Laboratorios | Al menos 80% de los laboratorios validados (al menos 26 de los ~32) |
| Examen final | ≥ 70% (42/60 preguntas) |
| Caso de estudio integrado del Módulo 15 | Resuelto correctamente |

El certificado lo emite Plain Vanilla Solutions SL con el nombre del alumno, la fecha y un código de verificación único. Tiene validez de 18 meses (el producto evoluciona rápido y se requiere recertificación).
...
Los 17 módulos están secuenciados con **dependencias lógicas estrictas** — el alumno no puede saltar adelante sin pagar el coste de no entender. Pero hay tres caminos de profundidad permitidos:

- **Camino completo (recomendado):** los 17 módulos en orden, ~23 horas + repaso.
- **Camino administrador básico:** M01, M02, M03, M04, M05, M07, M08, M16 (≈ 11 horas). Cubre lo imprescindible para que un admin haga onboarding del producto sin profundizar en seguridad.
- **Camino especialista en seguridad:** M01-M02 (contexto) + M06, M09, M10, M11, M12, M14 (≈ 13 horas). Asume que la parte de adopción la hace otro perfil.

El examen final cubre los 17 módulos. Los caminos parciales no permiten certificación, solo competencia funcional.

---

## 1. Mapa de competencias del curso

Las ocho áreas de competencia que estructuran el curso y el examen final:

| Área | Peso examen | Módulos que la cubren |
|---|---|---|
| **A. Fundamentos y arquitectura** | 13% | M01, M02 |
| **B. Licenciamiento y planificación** | 8% | M03, M16 (parte) |
| **C. Identidad de agentes (Entra Agent ID)** | 17% | M06, M09 (parte) |
| **D. Registro y ciclo de vida** | 13% | M07, M08 |
| **E. Acceso y Conditional Access** | 10% | M09 |
| **F. Protección de datos (Purview)** | 17% | M10, M11 |
| **G. Monitorización y respuesta (Defender)** | 12% | M12 |
| **H. Gobernanza, costes y operación** | 10% | M04, M05, M13, M14, M15, M16 |

**Total:** 100% — 60 preguntas en el examen final, distribuidas según los pesos.

---

## 2. Resumen de los 17 módulos

| # | Título | Duración | Fase | Dependencias | # Labs | # Preguntas examen |
|---|---|---|---|---|---|---|
| 01 | Fundamentos: ¿Qué es Microsoft Agent 365? | 90 min | F2 | — | 0 | 4 |
| 02 | Arquitectura y componentes | 90 min | F3 | M01 | 1 | 4 |
| 03 | Licenciamiento, prerrequisitos y planificación | 90 min | F3 | M01, M02 | 1 | 4 |
| 04 | Roles administrativos y delegación | 60 min | F3 | M02 | 1 | 3 |
| 05 | Configuración inicial del tenant | 90 min | F3 | M03, M04 | 2 | 3 |
| 06 | Microsoft Entra Agent ID e identidades | 120 min | F4 | M02, M04 | 3 | 7 |
| 07 | Agent Registry y Agent Map | 90 min | F4 | M02, M05 | 2 | 4 |
| 08 | Despliegue, distribución y ciclo de vida | 120 min | F4 | M07 | 3 | 4 |
| 09 | Permisos, accesos y Conditional Access | 90 min | F4 | M06, M08 | 2 | 6 |
| 10 | Microsoft Purview y protección de datos | 90 min | F5 | M02, M07 | 2 | 5 |
| 11 | DLP, sensitivity labels y compliance | 90 min | F5 | M10 | 3 | 5 |
| 12 | Monitorización, auditoría y reporting | 90 min | F5 | M02, M07, M10 | 2 | 7 |
| 13 | Copilot Control System integrado | 60 min | F5 | M01, M02 | 1 | 2 |
| 14 | Gobernanza avanzada y políticas | 90 min | F6 | M07, M08, M11, M12 | 2 | 3 |
| 15 | Troubleshooting y casos prácticos | 60 min | F6 | Todos los anteriores | 3 | 2 |
| 16 | Costes y optimización | 60 min | F6 | M03 | 1 | 1 |
| 17 | Examen final de certificación | 90 min | F7 | Todos | — | — |

**Totales:**
- 16 módulos de contenido + 1 módulo examen
- ~1380 minutos = **23 horas de teoría/labs**
- ~32 laboratorios prácticos
- 60 preguntas en el examen final
...
**Duración total:** 90 min · **Fase:** F2 (prototipo) · **Dependencias:** ninguna
...
|---|---|---|
| 1.1 El problema que resuelve Agent 365 | 15 min | Agent sprawl, multiplicación de agentes, shadow AI, riesgos de gobernanza. Casos reales. |
| 1.2 Posicionamiento: control plane, no builder | 20 min | Agent 365 vs Copilot Studio vs Foundry vs M365 Agents SDK vs Agent 365 SDK. Diagrama de capas. |
| 1.3 Los cuatro stakeholders core | 15 min | Roles M365, Entra, Purview, Defender admin. Responsabilidades de cada uno. |
| 1.4 Agent 365 vs Copilot Control System (CCS) | 15 min | "CCS gobierna a las personas que usan IA; Agent 365 gobierna a los agentes mismos". Cuándo se usa cada uno. |
| 1.5 Cronología del producto | 10 min | Ignite 2025, Frontier preview, GA 1 mayo 2026. Capacidades GA vs preview vs Frontier. |
| 1.6 Resumen y próximos pasos | 15 min | Mapa mental del curso. Cómo el resto de módulos profundizan. |
...
**Reparto al examen.** 4 preguntas (Área A — Fundamentos):
- 1 pregunta multiple-choice sobre la diferencia Agent 365 vs Copilot Studio.
- 1 pregunta multiple-choice sobre los stakeholders core.
- 1 pregunta drag-and-drop emparejando capacidad ↔ producto correcto.
- 1 pregunta de escenario sobre cuándo aplicar Agent 365 vs CCS.
...
**Duración total:** 90 min · **Fase:** F3 · **Dependencias:** M01
...
| 2.2 Microsoft 365 admin center: Agent workload | 20 min | Overview, Registry, Map, hero metrics, settings. Capturas guiadas. |
| 2.3 Tipos de agentes gestionables | 15 min | MCS DA/CEA/BP, Foundry LOB/non-LOB/hosted, Agent Builder, SharePoint, Toolkit, Agent instance. Tabla comparativa. |
| 2.4 Categorías por publisher | 10 min | Your organization (incluye your users), Third Party, Microsoft. Implicaciones de governance. |
| 2.5 Work IQ MCP servers | 10 min | Outlook, Word, Teams, SharePoint, OneDrive, User, Dataverse/Dynamics, Copilot. Rol en runtime. |
| 2.6 Microsoft 365 Agents SDK vs Agent 365 SDK | 10 min | Distinción crítica. Diagrama de capas. Uso conjunto. |
| 2.7 Resumen y mapa mental | 10 min | Mapa de los componentes que se desarrollarán en módulos posteriores. |
...
**Reparto al examen.** 4 preguntas (Área A):
...
- 1 escenario: identificar dónde se gestiona X capacidad.

---

### Módulo 03 — Licenciamiento, prerrequisitos y planificación

**Duración total:** 90 min · **Fase:** F3 · **Dependencias:** M01, M02
...
| Sección | Duración | Contenido |
|---|---|---|
| 3.1 SKUs disponibles y precios (mayo 2026) | 15 min | Agent 365 $15, E7 $99 (con/sin Teams), E5, Entra Suite $12, P1, P2. Tabla. |
| 3.2 Reglas de cobertura: OBO vs autonomous | 15 min | Quién paga qué. Casos. Estado preview de autonomous. |
...
| 3.4 Modelos de consumo paralelos | 15 min | Copilot Credits ($200/pack 25k), Foundry per-token, P3 plan con CCCUs. Por qué hay 3 facturas distintas. |
| 3.5 Frontier preview vs GA | 10 min | 25 licencias gratuitas en Frontier; modelo per-instance vs per-user en GA. |
| 3.6 Decisión: standalone vs E7 | 10 min | Cuándo $15 vs $99. Tabla de break-even por organización. |
| 3.7 Planificación de despliegue | 15 min | Piloto → expansión → general availability. Sizing. |
...
**Reparto al examen.** 4 preguntas (Área B):
- 1 cálculo: coste mensual de un escenario dado.
- 1 multiple-choice: qué licencia se necesita para X capacidad.
- 1 multiple-choice: cobertura OBO en un caso concreto.
...
**Duración total:** 60 min · **Fase:** F3 · **Dependencias:** M02
...
| Sección | Duración | Contenido |
|---|---|---|
| 4.1 Catálogo de roles | 15 min | Tabla con cada rol, su ámbito y restricciones. |
| 4.2 Principio de least-privilege aplicado | 10 min | Por qué AI Reader > Global Admin para visibilidad. Riesgos de privilegio excesivo. |
...
| 4.5 Resumen | 10 min | Cierre con recomendaciones. |
...
**Reparto al examen.** 3 preguntas (Área H):
- 1 multiple-choice: rol mínimo para ver Risky Agents report.
- 1 multiple-choice: AI Administrator vs Cloud Application Administrator.
- 1 escenario: diseñar delegación para X organización.

---

### Módulo 05 — Configuración inicial del tenant

**Duración total:** 90 min · **Fase:** F3 · **Dependencias:** M03, M04
...
| 5.2 Activación: paso a paso | 25 min | Copilot Frontier toggle, Terms of Service, Agents Overview. Capturas. |
| 5.3 Configuración de Defender | 15 min | Microsoft 365 connector, audit logs, alertas iniciales. |
| 5.4 Configuración de Purview | 15 min | DSPM, AI observability, sensitivity labels habilitadas para SharePoint/OneDrive. |
...
- 1 troubleshooting: por qué no aparece la opción Copilot Frontier en Settings.
- 1 escenario: validar que el setup está completo.

---

### Módulo 06 — Microsoft Entra Agent ID e identidades de agentes

**Duración total:** 120 min · **Fase:** F4 · **Dependencias:** M02, M04
...
| 6.2 Flujos de autenticación | 20 min | OBO (delegated) vs own identity (autonomous). Diagramas de tokens. |
...
| 6.6 Custom security attributes | 10 min | Segmentación. Casos de uso. |
...
| 6.8 APIs Graph para identidades | 10 min | `riskyAgents`, `agentRiskDetections`, `signInEventTypes`. Ejemplos. |
...
**Duración total:** 90 min · **Fase:** F4 · **Dependencias:** M02, M05
...
| Sección | Duración | Contenido |
|---|---|---|
| 7.1 Agent Registry: estructura | 20 min | Metadata por agente, columnas, filtros, ordenación. |
| 7.2 Agent Map: visualización | 20 min | Clusters por plataforma, fit-to-view, full screen, max agents. |
...
| 7.5 Registry sync multicloud 🟡 Preview | 15 min | AWS Bedrock, Google Gemini Enterprise. Cómo se conecta y limitaciones. |
...
**Reparto al examen.** 4 preguntas (Área D):
...
**Duración total:** 120 min · **Fase:** F4 · **Dependencias:** M07
...
| Sección | Duración | Contenido |
|---|---|---|
| 8.1 Las 11 acciones de gobernanza | 25 min | Publish, Activate, Deploy, Pin, Block, Unblock, Remove, Delete, Approve Updates, Manage Ownerless, Reassign. Tabla con efecto y reversibilidad. |
| 8.2 Wizard de publishing | 25 min | Submission, Review, Select users/groups, Preinstall, Apply Template, Permissions review, Admin consent. |
| 8.3 Plantillas Default vs Custom | 15 min | Qué incluye cada una. Cuándo usar Custom. |
| 8.4 Pinning y propagación | 10 min | 3 slots, hasta 6h propagación, solo agentes deployed. |
| 8.5 Remove vs Delete | 10 min | Diferencia. SharePoint Embedded container. 24h propagación. |
| 8.6 Ownerless y Reassign | 15 min | Cómo aparece. Quién puede reasignar. Limitación a Agent Builder. |
| 8.7 Diseño del ciclo de vida | 15 min | Plantilla de proceso para una organización. |
...
**Duración total:** 90 min · **Fase:** F4 · **Dependencias:** M06, M08
...
| Sección | Duración | Contenido |
|---|---|---|
| 9.1 Application vs Delegated Permissions | 15 min | Diferencias. Cuándo cada una. Common permissions list. |
| 9.2 Admin consent | 10 min | Cómo otorgarlo. Por qué a veces queda pending. |
| 9.3 Conditional Access para agentes 🟢 GA | 25 min | Scope, target, conditions, grants. Casos típicos. |
| 9.4 Report-only mode | 10 min | Por qué es crítico. Cómo monitorizar. |
| 9.5 Identity Protection para agentes 🟡 Preview (P2) | 15 min | Detecciones offline, Risky Agents report. |
...
**Reparto al examen.** 6 preguntas (Áreas C+E):
...
**Duración total:** 90 min · **Fase:** F5 · **Dependencias:** M02, M07
...
| Sección | Duración | Contenido |
|---|---|---|
| 10.1 Mapa de capabilities Purview para Agent 365 | 15 min | Tabla con soportado/no soportado y notas. |
...
| 10.4 Data classification con SITs | 15 min | SITs out-of-the-box, trainable classifiers. Aplicación a prompts/responses. |
...
| 10.6 Resumen | 10 min | Cierre y transición a M11. |
...
**Reparto al examen.** 5 preguntas (Área F):
...
**Duración total:** 90 min · **Fase:** F5 · **Dependencias:** M10
...
| Sección | Duración | Contenido |
|---|---|---|
| 11.1 DLP para Agent 365 | 20 min | Especificar agent instance como user. Casos: Teams, OneDrive/SharePoint, emails. |
...
| 11.5 eDiscovery | 10 min | `Type:Contains:Copilot activity`. Workflow legal hold. |
| 11.6 Data Lifecycle Management | 10 min | Retention policies. Audit log retention. |
...
**Duración total:** 90 min · **Fase:** F5 · **Dependencias:** M02, M07, M10
...
| Sección | Duración | Contenido |
|---|---|---|
| 12.1 Centralized monitoring en Defender | 15 min | Cómo llegan los eventos. Connector. |
...
| 12.4 Real-time protection runtime 🟡 Preview | 15 min | XPIA vs UPIA. Fail-open. Cómo se inserta en runtime. |
| 12.5 Defender for Cloud Apps: AI Agent Inventory | 10 min | Inventario. Posture. Attack paths. |
| 12.6 Shadow AI / agentes locales | 10 min | Intune block policies. OpenClaw, GitHub Copilot CLI, Claude Code. |
...
**Reparto al examen.** 7 preguntas (Área G):
...
- 1 multiple-choice: detección Shadow AI.
- 1 escenario: correlación Risks column ↔ alerta.

---

### Módulo 13 — Copilot Control System integrado con Agent 365

**Duración total:** 60 min · **Fase:** F5 · **Dependencias:** M01, M02
...
| Sección | Duración | Contenido |
|---|---|---|
| 13.1 Los tres pilares CCS | 20 min | Security & Governance, Management Controls, Measurement & Reporting. |
...
| 13.3 CCS ↔ Agent 365 | 20 min | Diferencias y complementariedades. Casos: cuándo cada uno. |
| 13.4 Resumen | 10 min | Cierre. |
...
**Reparto al examen.** 2 preguntas (Área H):
- 1 drag-and-drop: capacidad ↔ pilar CCS.
...
**Duración total:** 90 min · **Fase:** F6 · **Dependencias:** M07, M08, M11, M12
...
| Sección | Duración | Contenido |
|---|---|---|
| 14.1 Custom Templates en profundidad | 20 min | Componer plantilla. Casos. |
| 14.2 SharePoint Agents governance | 15 min | .agent files, permisos archivo, RCD, RAC, DLP por extensión. |
| 14.3 Copilot Studio governance | 15 min | Power Platform admin center. DLP, block publishing, environment routing, sharing. |
| 14.4 Registry sync multicloud 🟡 Preview | 10 min | AWS Bedrock, Google Gemini. Conexión y limitaciones. |
| 14.5 Shadow AI page 🟡 Preview | 5 min | OpenClaw, GitHub Copilot CLI, Claude Code. |
| 14.6 Diseño de estrategia coherente | 20 min | Cómo evitar inconsistencias entre admin centers. Plantilla. |
...
- 1 multiple-choice: RCD vs RAC.
- 1 multiple-choice: limitaciones de Information Barriers en SharePoint Embedded.

---

### Módulo 15 — Troubleshooting y casos prácticos

**Duración total:** 60 min · **Fase:** F6 · **Dependencias:** Todos los módulos anteriores
...
| Sección | Duración | Contenido |
|---|---|---|
| 15.1 Árbol de decisión: síntomas → diagnóstico | 15 min | "Agent not available", license errors, OAuth pending, etc. |
...
| 15.4 Caso 2: Ownerless tras hard delete del usuario | 10 min | Reasignar y limpiar lifecycle. |
| 15.5 Caso 3: Sponsor que cambia de rol | 10 min | Lifecycle workflow + sponsorship transfer. |
...
*Lab 15.3 es la prueba integrada del curso, evaluable, requerida para la certificación.* El alumno recibe un escenario realista con 5 problemas simultáneos. Debe identificarlos y resolverlos en un tenant de pruebas. Output: informe en 1 página con diagnóstico + acciones correctivas + medidas preventivas.

**Reparto al examen.** 2 preguntas (Área H):
- 1 troubleshooting: dado un síntoma, identificar diagnóstico.
...
**Duración total:** 60 min · **Fase:** F6 · **Dependencias:** M03
...
| Sección | Duración | Contenido |
|---|---|---|
| 16.1 Las tres líneas de billing | 15 min | Per-seat (Agent 365), Copilot Credits (Copilot Studio), per-token (Foundry). |
...
| 16.5 Best practices de optimización | 15 min | Registry hygiene, block unused, monitor consumption. |
...
**Reparto al examen.** 1 pregunta (Área B):
...
Estructura completa en la sección [4. Estructura del examen final](#4-estructura-del-examen-final).

---

## 4. Estructura del examen final
...
| Área | Peso | Preguntas |
|---|---|---|
| A. Fundamentos y arquitectura | 13% | 8 |
| B. Licenciamiento y planificación | 8% | 5 |
| C. Identidad de agentes | 17% | 10 |
| D. Registro y ciclo de vida | 13% | 8 |
| E. Acceso y Conditional Access | 10% | 6 |
| F. Protección de datos | 17% | 10 |
| G. Monitorización y respuesta | 12% | 7 |
| H. Gobernanza, costes y operación | 10% | 6 |
| **Total** | **100%** | **60** |
...
## 5. Matriz de competencias completa
...
| Área | Objetivos de aprendizaje | # Preguntas en examen |
|---|---|---|
| A. Fundamentos y arquitectura | OA-01.1 a OA-01.5; OA-02.1 a OA-02.5 | 8 |
| B. Licenciamiento y planificación | OA-03.1 a OA-03.6; OA-16.1 a OA-16.4 | 5 |
| C. Identidad de agentes | OA-06.1 a OA-06.7; OA-09.1, OA-09.2 | 10 |
| D. Registro y ciclo de vida | OA-07.1 a OA-07.5; OA-08.1 a OA-08.6 | 8 |
| E. Acceso y Conditional Access | OA-09.3 a OA-09.6 | 6 |
| F. Protección de datos | OA-10.1 a OA-10.5; OA-11.1 a OA-11.6 | 10 |
| G. Monitorización y respuesta | OA-12.1 a OA-12.7 | 7 |
| H. Gobernanza, costes y operación | OA-04.1 a OA-04.4; OA-05.1 a OA-05.5; OA-13.1 a OA-13.3; OA-14.1 a OA-14.6; OA-15.1 a OA-15.3 | 6 |

**Total:** 87 objetivos de aprendizaje cubiertos por 60 preguntas (algunos objetivos se cubren con múltiples preguntas; otros con una). Cada pregunta cubre 1-2 objetivos principales.
...
**Banco de preguntas del examen.** Se construye **incrementalmente**: cada módulo aporta sus N preguntas al producirse, no se deja para Fase 7. En Fase 7 se hace la revisión integral del banco, balanceo de dificultad, y validación final de la matriz de competencias.
